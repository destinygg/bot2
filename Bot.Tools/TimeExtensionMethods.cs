...
namespace Bot.Tools {
  public static class TimeExtensionMethods {
    ...
    // http://stackoverflow.com/a/7844741
    ...
    public static bool IsWithin(this DateTime test, DateTime now, TimeSpan window) => (test - now).Duration() <= window;
    ...
    /// http://stackoverflow.com/a/14285561
    /// </summary>
